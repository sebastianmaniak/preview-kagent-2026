        ...
        <div className="rd-container rd-hero-inner">
          <div className="rv" style={{ textAlign: 'center', maxWidth: 880, margin: '0 auto' }}>
            ...
            <div className="rd-hero-meta">
              <span><Icon name="check" size={14} style={{ color: '#8A3FFC' }} /> CNCF Sandbox</span>
          ...
          <div className="rd-std-grid">
            ...
            <div className="rd-std-card rv">
              <div className="rd-std-mark" style={{ background: 'linear-gradient(135deg,#326CE5,#1D4ED8)' }}>
                <svg width="28" height="28" viewBox="0 0 722 702" fill="none">
                  <path d="M361 1l178 103v206L361 413 183 310V104L361 1z" fill="rgba(255,255,255,0.15)" stroke="#fff" strokeWidth="18"/>
                  <g fill="#fff">
                    <circle cx="361" cy="207" r="30"/>
                    <rect x="354" y="120" width="14" height="60" rx="7"/>
                    <rect x="354" y="230" width="14" height="60" rx="7" transform="rotate(0 361 260)"/>
                    <rect x="354" y="120" width="14" height="60" rx="7" transform="rotate(60 361 207)"/>
                    <rect x="354" y="230" width="14" height="60" rx="7" transform="rotate(60 361 207)"/>
                    <rect x="354" y="120" width="14" height="60" rx="7" transform="rotate(120 361 207)"/>
                    <rect x="354" y="230" width="14" height="60" rx="7" transform="rotate(120 361 207)"/>
                    <rect x="354" y="120" width="14" height="60" rx="7" transform="rotate(180 361 207)"/>
                    <rect x="354" y="120" width="14" height="60" rx="7" transform="rotate(240 361 207)"/>
                    <rect x="354" y="230" width="14" height="60" rx="7" transform="rotate(240 361 207)"/>
                    <rect x="354" y="120" width="14" height="60" rx="7" transform="rotate(300 361 207)"/>
                    <rect x="354" y="230" width="14" height="60" rx="7" transform="rotate(300 361 207)"/>
                  </g>
                </svg>
              </div>
        ...
        <div className="rd-container">
          ...
          <div className="rd-comm-grid">
            <div className="rd-comm-card rv">
              ...
              <div className="rd-stat">5,247</div>
